...
if consumer_category=='residential':
    demand_charge = 70 #INR/kWh/Month 
elif consumer_category=='commercial':
    demand_charge=150
else:
    demand_charge=300
