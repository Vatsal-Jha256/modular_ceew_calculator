...
num_hours_in_year, charge, battery_replacement_schedule, battery_costs, bpc_wo):
    ...
    #print(f"Total CAPX cost for solar+Grid+BESS system: {format_indian_currency(Capx_cost)}")
    #print(f"Total O&M cost for solar+Grid+BESS system: {format_indian_currency(total_om_cost)}")
